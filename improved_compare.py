...
def load_json_safe(raw):
    """Intenta cargar una cadena como JSON, eliminando prefijos si es necesario."""
    ...
    try:
        ...
        print(f"Texto problemático (primeros 50 caracteres): {json_text[:50]}...")
        return None
...
if __name__ == "__main__":
    compare_json_columns("CUST-6883 Oasis 2215  whodunit v2.xlsx", "CUST-6883_diff_results.xlsx")
